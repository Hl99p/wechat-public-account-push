export const USER_CONFIG = {
  ...
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a78ac9425c6888629f4cd64b40fb41dd",
  ...
  USERS: [
    {
      ...
      festivals: [{"type": "*生日", "name": "老婆", "year": "2003", "date": "08-12"}],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [{"keyword": "love_day", date: "2022-01-03"}]
    },
    {
      name: "老婆1",
      id: "",
  ...
  CALLBACK_TEMPLATE_ID: "joVNhVQMasYCtIEIUmxtihqJaSycYdtTd2YCqe8_19A	",
